...
//Computes the number of lines a MultiCell of width w will take
    ...
    $this->cell(304,6,utf8_decode("$institucion->NOMBRE_ESTABLECIMIENTO"),1,"","C");
 	...
 	$this->cell(25,6,utf8_decode("PERIODO: IV"),0,"","L");
 	...
 	foreach($areas as $area){
 		...
 		$asignaturas=asignatura::where('id_area',$area->id)->where('id_curso',$curso_id)->get();
 			foreach($asignaturas as $asignatura){
 		        ...
 		        $logro_serx="";
 		        $defc=0;
 				$logros_saber=logro::where('id_asignatura',$asignatura->id)->where('PERIODO','4')->where('TIPO_LOGRO','SABER')->get();
 				$logros_hacer=logro::where('id_asignatura',$asignatura->id)->where('PERIODO','4')->where('TIPO_LOGRO','HACER')->get();
 				$logros_ser=logro::where('id_asignatura',$asignatura->id)->where('PERIODO','4')->where('TIPO_LOGRO','SER')->get();
				...
				$pdf::SetX(10);
				$pdf::Row(array("","$logro_saberx","$logro_hacerx","$logro_serx","","","","","","   $fallasp4","   $asignatura->IHS"));
