...
<div class="my-3 p-3 bg-white rounded box-shadow">
	...
	<div class="col-md-12">
	      ...
	      <div class="my-3 p-3 bg-white rounded box-shadow">
			...
			<td class="sorting_1">{{$estudiante->APELLIDO1.' '.$estudiante->APELLIDO2.' '.$estudiante->NOMBRES}}</td>
			<td class="sorting_1"><input class="form-control" type="number" value="{{$f1}}" id="example-number-input" name="f1[]"></td>
			<td class="sorting_1"><input class="form-control definitivaperiodo" type="number" value="{{$p1}}" id="example-number-input1" max='{{$periodo_anual->nota_max}}' min='{{$periodo_anual->nota_min}}' step='any' name="p1[]"></td></td>
			<td class="sorting_1"><input class="form-control" type="number" value="{{$f2}}" id="example-number-input" disabled name="f2[]"></td></td>
			<td class="sorting_1"><input class="form-control definitivaperiodo" type="number" value="{{$p2}}" id="example-number-input2" disabled max='{{$periodo_anual->nota_max}}' min='{{$periodo_anual->nota_min}}' step='any' name="p2[]"></td></td>
			<td class="sorting_1"><input class="form-control" type="number" value="{{$f3}}" id="example-number-input" disabled name="f3[]"></td></td>
			<td class="sorting_1"><input class="form-control definitivaperiodo" type="number" value="{{$p3}}" id="example-number-input3" disabled max='{{$periodo_anual->nota_max}}' min='{{$periodo_anual->nota_min}}' step='any' name="p3[]"></td></td>
			<td class="sorting_1"><input class="form-control" type="number" value="{{$f4}}" id="example-number-input" disabled name="f4[]"></td></td>
			<td class="sorting_1"><input class="form-control definitivaperiodo" type="number" value="{{$p4}}" id="example-number-input4" disabled max='{{$periodo_anual->nota_max}}' min='{{$periodo_anual->nota_min}}' step='any' name="p4[]"></td></td>
			</tr>
			<input hidden value='{{$estudiante->CODIGO}}' name="dni[]" >
			<?php $i++; ?>
			@endforeach
			</tbody>
			</table>
