...
@section('head')
<title>{{$asignatura->NOMBRE_ASIGNATURA}}</title>
@endsection
...
<div class="d-flex align-items-center p-5 text-white-50 bg-purple rounded box-shadow">
        ...
        <div class="lh-100">
          ...
          <small>Curso:: {{$asignatura->curso->CURSO}}</small>
          </br>
...
<div class="my-3 p-3 bg-white rounded box-shadow">
	...
	<div class="col-md-12">
	      ...
	      <div class="my-3 p-3 bg-white rounded box-shadow">
			...
			<td><center><a href="{{url('/delete_logroa/'.$logros1->id_logro.'/'.$asignatura->id)}}"><button><i class="fas fa-trash"></i></button></a>&nbsp;&nbsp;&nbsp;<button onclick="edit_logro({{$logros1->id_logro}},'{{url('/edit_logroa/')}}')"><i class="fas fa-edit"></i></button></center></td>
			</tr>
			@endif
			@endforeach
			</tbody>
...
<div class="my-3 p-3 bg-white rounded box-shadow">
	...
	<div class="col-md-12">
	      ...
	      <div class="my-3 p-3 bg-white rounded box-shadow">
			...
			<td><center><a href="{{url('/delete_logroa/'.$logros2->id_logro.'/'.$asignatura->id)}}"><button><i class="fas fa-trash"></i></button></a>&nbsp;&nbsp;&nbsp;<button onclick="edit_logro({{$logros2->id_logro}},'{{url('/edit_logroa/')}}')"><i class="fas fa-edit"></i></button></center></td>
			</tr>
			@endif
			@endforeach
			</tbody>
...
@include("administrative.Adm_asignatures.Modal.logros_psubida")
@include("administrative.Adm_asignatures.Modal.logros_edit")
