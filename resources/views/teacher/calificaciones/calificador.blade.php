...
<div class="my-3 p-3 bg-white rounded box-shadow">
	...
	<div class="col-md-12">
	      ...
	      <div class="my-3 p-3 bg-white rounded box-shadow">
			...
			<td class="sorting_1"><input class="form-control definitivaperiodo" type="number" value="{{$p1}}"  id="example-number-input1"  max='{{$periodo_anual->nota_max}}' min='{{$periodo_anual->nota_min}}' step='any' name="p1[]" readonl></td></td>
			<td class="sorting_1"><input class="form-control" type="number" value="{{$f2}}" id="example-number-input"  name="f2[]" readonly></td></td>
			<td class="sorting_1"><input class="form-control definitivaperiodo" type="number" value="{{$p2}}"  id="example-number-input2"  max='{{$periodo_anual->nota_max}}' min='{{$periodo_anual->nota_min}}' step='any' name="p2[]" readonl></td></td>
